...
| `heating_circuit_2` | feature | Enable Heating circuit 2 entities | 2 | e.g. Auswahl Heizkreis 2, Mischer (M21) ZU |
| `heating_circuit_3` | feature | Enable Heating circuit 3 entities | 1 | e.g. Mischer (M22) Zu |
| `cooling` | feature | Enable Cooling entities | 2 | e.g. Solltemp. dyn. Kühlung, Kühlung Raumsolltemperatur |
...
| `energy` | feature | Enable Energy & runtime entities | 7 | e.g. Mischerlaufzeit, Mischerlaufzeit, Wärmemenge * Heizen 5-8, … |
| `heat_source` | feature | Enable Heat source (brine) entities | 1 | e.g. Rücklauftemp. gem. Primärkreis (R24) |
| `status` | feature | Enable Component status entities | 8 | e.g. Verdichter 2, 2.Wärmeerzeuger (E10), Flanschheizung (E9), … |
