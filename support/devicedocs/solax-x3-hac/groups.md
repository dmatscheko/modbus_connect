...
**Total register + template entities:** 80
...
| `advanced` | tier | Enable Advanced entities | 62 | The full detail — deep settings, per-component diagnostics and secondary readings. |
| `charging` | feature | Enable Charging entities | 39 | e.g. Charger Use Mode, Start Charge Mode, Boost Mode, … |
