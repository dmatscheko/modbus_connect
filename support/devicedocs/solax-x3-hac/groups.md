...
**Total register + template entities:** 81
...
| `advanced` | tier | Enable Advanced entities | 63 | The full detail — deep settings, per-component diagnostics and secondary readings. |
| `charging` | feature | Enable Charging entities | 40 | e.g. Charger Use Mode, Start Charge Mode, Boost Mode, … |
| `grid` | feature | Enable Grid entities | 10 | e.g. Grid Current L1, Grid Current L2, Grid Current L3, … |
| `settings` | feature | Enable System settings entities | 14 | e.g. Meter Setting, ECO Gear, Green Gear, … |
