...
| --- | --- | --- | --- | --- |
| Dimplex Sole/Wasser-Wärmepumpe SI 11TU | [`dimplex-si-11tu`](./dimplex-si-11tu/registers.md) (134) | [Dimplex — NWPM Modbus TCP Datenpunktliste (Wärmepumpenmanager)](https://dimplex.atlassian.net/wiki/spaces/DW/pages/2873393288/NWPM+Modbus+TCP) | official | verified |
...
| Pichler Lüftungsgerät LG 150 - LG 250 | [`pichler-lg150-lg250`](./pichler-lg150-lg250/registers.md) (190) | [Pichler / LS-Control — Modbus register list (controller ES1015, LG150AB/LG250A)](https://www.pichlerluft.at/unterlagen.html?file=files/content/downloads/LOGIN/LG%20150AB-LG250A/LIST_Modbus_ES1015_FW_LG150AB_LG250A_v2.0.0.xlsx) | official | verified |
